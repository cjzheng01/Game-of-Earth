...
export abstract class LivingEntity extends Entity {
  ...
  public readonly actionRange: number =
    Math.max(this.dimension.height, this.dimension.width) / 2;

  protected wandering: boolean = false;
  private wanderFrameCount = 0;
  protected wanderDirection: IVector = { dx: 0, dy: 0 };

  protected readonly pq = new PriorityQueue({
